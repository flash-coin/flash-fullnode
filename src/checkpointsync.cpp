...
const std::string CSyncCheckpoint::strMainPubKey = "042227c9245076c0f3f705174552d4238ed2156253b0fd2f39f758aa2468bba081d460c7938b90afb2eb44d144015a061f7063d0e11f01a3736f853c7a7ca45524";
const std::string CSyncCheckpoint::strTestPubKey = "042227c9245076c0f3f705174552d4238ed2156253b0fd2f39f758aa2468bba081d460c7938b90afb2eb44d144015a061f7063d0e11f01a3736f853c7a7ca45524";
...
bool ResetSyncCheckpoint()
{
    ...
    if (!WriteSyncCheckpoint((mapBlockIndex.count(hash) && mapBlockIndex[hash]->IsInMainChain())? hash : Params().GetConsensus().hashGenesisBlock))
...
bool CheckCheckpointPubKey()
{
    ...
    std::string strMasterPubKey = Params().NetworkIDString() == "testnet3" ? CSyncCheckpoint::strTestPubKey : CSyncCheckpoint::strMainPubKey;

...
void Shutdown()
{
    ...
    RenameThread("flashcoin-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/flash-coin/flashcoin>";
    const std::string URL_WEBSITE = "<https://flashcoin.io>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("flashcoin-loadblk");
    CImportingNow imp;
